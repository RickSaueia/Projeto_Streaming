...
<body>
    ...
    <div id="content" style="display:none;">
        ...
        <nav class="nav-box">
            ...
            <div class="logo">
                <h1 class="logo_h1">LNA</h1>
                <h1 class="logo2_h1">STREAM</h1>
            </div>
            ...
            <div class='perfil-nav-link'>
                ...
                <div class='perfil-nav-link-item'>
                    ...
                    <a href='Premium/pg_premium.php' class='texto-menor'>Assista ao conteúdo exclusivo!</a>
                </div>
                <div class='perfil-nav-link-item'>
        ...
        if ($email != "") {
            ...
            $generos = ["Ação", "Aventura", "Suspense", "Fantasia", "Drama", "Romance", "Comédia"];
