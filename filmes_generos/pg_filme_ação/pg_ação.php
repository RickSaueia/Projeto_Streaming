    ...
    <div id="content" style="display:none;">
        ...
        <nav class="nav-box">
            ...
            <div class="navegar" id="navegar">
                ...
                <div class="generos_nav">
                    ...
                    <div class="generos_nav_links">
                        <a href="#">Ação</a>
                        <a href="../pg_filme_comedia/pg_comedia.php">Comédia</a>
                        <a href="../pg_filme_romance/pg_romance.php">Romance</a>
                        <a href="../pg_filme_suspense/pg_suspense.php">Suspense</a>
                        <a href="../pg_filme_aventura/pg_aventura.php">Aventura</a>
                        <a href="../pg_filme_drama/pg_drama.php">Drama</a>
                        <a href="../pg_filme_fantasia/pg_fantasia.php">Fantasia</a>
                    </div>
            ...
            <div class='perfil-nav-link'>
                ...
                <div class='perfil-nav-link-item'>
                    <a href='../../premium/pg_premium.php' class='link-user-principal'>Premium</a>
                    <a href='../../premium/pg_premium.php' class='texto-menor'>Torne-se Premium.</a>
                </div>
                <div class='perfil-nav-link-item'>
                ...
                if ($plano_assinatura == "gratuito") {
                    ...
                    <div class='perfil-nav-link'>
                        ...
                        <div class='perfil-nav-link-item'>
                            <a href='../../pagamento_plano/pg_pagamento.php' class='link-user-principal'>Premium</a>
                            <a href='../../pagamento_plano/pg_pagamento.php' class='texto-menor'>Torne-se Premium.</a>
                        </div>
                        <div class='perfil-nav-link-item'>
                            <a href='../../logout.php' class='link-user-principal'>Sair</a>
                            <a href='../../logout.php' class='texto-menor'>Volte sempre!</a>
