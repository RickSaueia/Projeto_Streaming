...
function seletor($genero, $sqlconn)
{
    ...
    while ($i < count($reg)){
                ...
                echo" <a href='../../pg_filmes/".$reg[$i]['titulo']."/".$reg[$i]['titulo'].".php' class='link-principal'></a>"; 
                echo"<a href='../../pg_filmes/".$reg[$i]['titulo']."/".$reg[$i]['titulo'].".php' class='link-botao'><i class='fa-solid fa-play botao-play'>
